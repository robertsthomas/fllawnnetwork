      ...
      <div className="p-4 pt-8 flex-grow flex flex-col">
        <div className="flex justify-between items-start">
          ...
          <div className="flex items-center">
            <span className="text-sm font-semibold text-gray-800">{provider.reviews.stars}</span>
            ...
            <span className="text-xs text-gray-500 ml-1">({provider.reviews.count})</span>
          </div>
        </div>
