      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            How Florida Lawn Network Works
          </h2>
          ...
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            <div className="relative">
              ...
              <div className="lg:mt-0 text-center">
                ...
                <p className="mt-2 text-base text-gray-500">
                  Enter your location and the service you need to browse lawn care providers in your
                  area.
                </p>
              </div>
              <div className="hidden lg:block absolute top-16 left-full transform -translate-x-1/2 mt-3 w-14 text-center lg:text-right lg:mt-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-14 text-primary-300 mx-auto"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            <div className="mt-10 lg:mt-0 relative">
              ...
              <div className="lg:mt-0 text-center">
                ...
                <p className="mt-2 text-base text-gray-500">
                  Read reviews, compare services, and select the provider that best fits your
                  specific needs.
                </p>
              </div>
              <div className="hidden lg:block absolute top-16 left-full transform -translate-x-1/2 mt-3 w-14 text-center lg:text-right lg:mt-0">
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="lg:mt-0 text-center">
                ...
                <p className="mt-2 text-base text-gray-500">
                  Request a quote directly through our platform and schedule your service with the
                  provider.
                </p>
              </div>
            </div>
