        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-lg text-primary-100">
              Join our network of top-rated providers and connect with customers looking for your
              services. Grow your business and reach more clients in your area.
            </p>
            <div className="mt-8 flex">
              <div className="inline-flex rounded-md shadow">
                ...
                >
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="ml-3 -mr-1 h-5 w-5 text-primary-600"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
