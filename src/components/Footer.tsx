            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  <li>
                    <Link
                      href="/directory?service=lawn-mowing"
                  ...
                  <li>
                    <Link
                      href="/directory?service=landscaping"
                      className="text-base text-gray-400 hover:text-gray-300 transition"
                    >
                      Landscaping
                    </Link>
                  ...
                  <li>
                    <Link
                      href="/directory?service=garden-design"
                      className="text-base text-gray-400 hover:text-gray-300 transition"
                    >
                      Garden Design
                    </Link>
                  ...
                  <li>
                    <Link
                      href="/directory?service=irrigation"
                      className="text-base text-gray-400 hover:text-gray-300 transition"
                    >
                      Irrigation
                    </Link>
                  ...
                  <li>
                    <Link
                      href="/directory?service=tree-services"
                      className="text-base text-gray-400 hover:text-gray-300 transition"
                    >
                      Tree Services
                    </Link>
