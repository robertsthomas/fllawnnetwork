...
export const metadata: Metadata = {
  ...
  description: 'Search for lawn care services in your area. Find and compare local lawn maintenance companies, landscaping services, and garden care professionals.',
};
