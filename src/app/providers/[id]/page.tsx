          ...
          <div className="mt-8 lg:mt-0">
            ...
            <div id="contact-form" className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
              ...
              <form className="space-y-4">
                ...
                <button 
                  type="submit"
                  className="w-full bg-primary-600 text-white py-2 px-4 rounded-md font-medium hover:bg-primary-700 transition focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
                >
                  Send Request
                </button>
                ...
                <div className="mt-4 text-center text-sm text-gray-500">
                  ...
                  <div className="flex justify-center space-x-4 mt-2">
                    ...
                    {provider.website && (
                      <a href={provider.website} target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700">
