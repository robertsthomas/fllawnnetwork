        ...
        <Card className="border-2 border-accent-100 bg-white">
            ...
            {isSubmitted ? (
              <div className="text-center py-6">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  We've received your claim request and will contact you via email within 1-2
                  business days to verify your ownership.
                </p>
                <Button onClick={() => router.push(`/providers/${id}`)} className="mt-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Must be an email associated with the business domain
                  </p>
                </div>
          ...
          <CardFooter className="bg-gray-50 px-6 py-4 border-t">
            <p className="text-xs text-gray-500">
              After submitting your claim, our team will review your information and may request
              additional verification. Once verified, you'll gain full access to manage your
              business listing.
            </p>
          </CardFooter>
        </Card>
